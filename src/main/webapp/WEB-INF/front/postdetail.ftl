<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <head>
	...
	<link href="${request.contextPath}/static/front/stylesheets/github.css"  rel="stylesheet" type="text/css" />
	<link href="${request.contextPath}/static/front/stylesheets/github.min.css"  rel="stylesheet" type="text/css" />
  </head>
  <body>
